...
public class ListExample {
	...
	public static void main(String[] args) {
		...
		//List<int> list = new ArrayList<>(); int 사용불가
		//List<Integer> list = new ArrayList<>(); integer 사용가능
		List<String> list = new ArrayList<>();//1.8부터는 생성자에 제네릭 표기 안해도됨
		//List<String> list = new LinkedList<>(); //둘중 하나만 사용해도됨
		
		String str1 = "Java";
		String str2 = "SpringBoot";
		System.out.println(list); // 컬렉션 특성상 toString()이 이미 재정의 되어 주소가 안나오고 내부요소가 나옴
		...
		// list 내부에 저장된 객체의 유무확인 countains() -> 있으면 true, 없으면 false
